...
from funciones import Busquedausuarios,registrarusuario,graba_diccionario, graba_diccionario_trabajador ,lee_diccionario_csv,graba_diccionario_id, lee_diccionario_csv_id, lee_diccionario_csv_nombre_mascota, sacar_usuarios,lee_diccionario_csv_trabajadores, lee_diccionario_csv_admin,graba_diccionario_admin
import datetime
...
def registrar_trabajadores():
    if request.method == 'POST':
                ...
                if valor == 'Entrar':
                    ...
                    if direccion not in diccionario_trabajadores:
                        diccionario_trabajadores[direccion] = {
                            'direccion': direccion,
                            'precio'  : precio,
                            'cp' : cp,
                            'detalles' : detalles,
